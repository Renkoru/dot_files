...
4. Polybar
   link polybar config
5. fish + (fisher? do we really need this?)
6. xbindkeys
7. git
...
23. pulseaudio
24. ncpamixer
25. thunar https://wiki.archlinux.org/index.php/thunar
26. poetry
27. qBittorrent
28. zathura
29. docker
...
31. vlc
32. node + nvm + npm
33. google-chrome | yay
34. pyenv
35. libnotify (notifications)
36. dunst (notifications)
* Troubleshooting
